...
echo "<pre>";
print_r($fileflyer->Get($password,$id,1,1,1)); // 12345- Id - http://www.fileflyer.com/view/d4TyuBe - Hancock 2008 Unrated 1080p DTS multisub HebSub-DjBiT-DownCenter.Me.part1.rar‬ - 1000 MB 
echo "</pre>";
